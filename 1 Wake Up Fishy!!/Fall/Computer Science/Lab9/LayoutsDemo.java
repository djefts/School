...
public class LayoutsDemo extends Application {
    ...
    public LayoutsDemo() {
        ...
        //criterion 1.4
        flowPane = new FlowPane(20.0, 20.0);
        ...
        flowBt2.setFont(font);
        //criterion 2.3B
        flowBt3.setFont(Font.font("Comic Sans MS", 16));
        //criterion 2.3C
        flowBt4.setStyle("-fx-font-family: 'Comic Sans MS'; -fx-font-size: 16px");
        ...
        shapes.add(new Ellipse(51, 51, 50, 30));        //left eye
        shapes.add(new Ellipse(201, 51, 50, 30));       //right eye
        shapes.add(new Circle(51, 51, 25));             //left pupil
        shapes.add(new Circle(201, 51, 25));            //right pupil
        
        shapes.get(0).setFill(Paint.valueOf("black"));
        shapes.get(1).setFill(Paint.valueOf("black"));
        shapes.get(2).setFill(Paint.valueOf("green"));
        shapes.get(3).setFill(Paint.valueOf("green"));
        regularPane.getChildren().addAll(shapes);
        //criterion 3.2
        borderBt5.setRotate(45.0);
        //criterion 3.3
